...
**billingAddress** | [**OrderAddress**](OrderAddress.md) | The billing address. This property is part of basket checkout information only. | [optional] 
...
**cEaEmployeeId** | **String** | EmployeeId of Store Associate, if the order was created in the store | [optional] 
**cEaStoreId** | **String** | This field contains the store id used for for clients to attribute sales to a specific store. | [optional] 
...
**customerInfo** | [**CustomerInfo**](CustomerInfo.md) | The customer information for logged in customers. This property is part of basket checkout information only. | [optional] 
...
**notes** | [**SimpleLink**](SimpleLink.md) | The notes for the line item container. | [optional] 
