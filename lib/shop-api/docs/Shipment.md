...
**shippingAddress** | [**OrderAddress**](OrderAddress.md) | The shipping address. | [optional] 
**shippingMethod** | [**ShippingMethod**](ShippingMethod.md) | The shipping method. | [optional] 
