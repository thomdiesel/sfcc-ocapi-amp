...
(function(root, factory) {
  ...
  describe('ProductItem', function() {
    ...
    it('should have the property cEaEmployeeId (base name: "c_eaEmployeeId")', function() {
      // uncomment below and update the code to test the property cEaEmployeeId
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });

    it('should have the property cEaManagerEmployeeId (base name: "c_eaManagerEmployeeId")', function() {
      // uncomment below and update the code to test the property cEaManagerEmployeeId
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });

    it('should have the property cEaOverrideReasonCode (base name: "c_eaOverrideReasonCode")', function() {
      // uncomment below and update the code to test the property cEaOverrideReasonCode
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });

    it('should have the property cEaPriceOverrideType (base name: "c_eaPriceOverrideType")', function() {
      // uncomment below and update the code to test the property cEaPriceOverrideType
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });

    it('should have the property cEaPriceOverrideValue (base name: "c_eaPriceOverrideValue")', function() {
      // uncomment below and update the code to test the property cEaPriceOverrideValue
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cMpProperties (base name: "c_mpProperties")', function() {
      // uncomment below and update the code to test the property cMpProperties
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });

    it('should have the property cSampleAttribute (base name: "c_sampleAttribute")', function() {
      // uncomment below and update the code to test the property cSampleAttribute
      //var instane = new ShopApi.ProductItem();
      //expect(instance).to.be();
    });
