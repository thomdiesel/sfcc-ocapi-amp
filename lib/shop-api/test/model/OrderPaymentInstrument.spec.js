...
(function(root, factory) {
  ...
  describe('OrderPaymentInstrument', function() {
    ...
    it('should have the property cEaRequireSignature (base name: "c_eaRequireSignature")', function() {
      // uncomment below and update the code to test the property cEaRequireSignature
      //var instane = new ShopApi.OrderPaymentInstrument();
      //expect(instance).to.be();
    });
