...
(function(root, factory) {
  ...
  describe('Product', function() {
    ...
    it('should have the property cMarketplace (base name: "c_marketplace")', function() {
      // uncomment below and update the code to test the property cMarketplace
      //var instane = new ShopApi.Product();
      //expect(instance).to.be();
    });

    it('should have the property cMarketplaceProductId (base name: "c_marketplace-product-id")', function() {
      // uncomment below and update the code to test the property cMarketplaceProductId
      //var instane = new ShopApi.Product();
      //expect(instance).to.be();
    });
